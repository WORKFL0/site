      ...
      <div className="container mx-auto container-padding relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium">{t.cta.limitedTime}: {t.cta.freeITScan}</span>
          </motion.div>
          ...
          >
            {t.cta.trustedBy} • {t.cta.averageResponse}
          </motion.p>
        </motion.div>
      </div>
    </section>
