...
const testimonials = [
  {
    ...
    content: 'Every business needs Workflo. They are the IT Masters. Fast, knowledgeable, to the point, down to earth, friendly and super cool! Workflo is the absolute it in IT!',
    rating: 5,
  ...
  },
  {
    ...
    company: 'Winix',
    content: 'Florian and his team are there to help. Whether it is about simple usability issues or the more serious stuff about network, servers, trustworthy backup systems and security. Workflo knows. They solve it instantly. With a smile.',
    rating: 5,
        ...
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 h-full flex flex-col relative overflow-hidden">
                {/* Quote mark */}
