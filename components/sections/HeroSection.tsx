        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-6 mb-8">
              ...
              >
                <motion.div 
                  className="text-3xl font-bold text-warning-yellow"
                  animate={{ scale: [1, 1.1, 1] }}
                  transition={{ duration: 2, repeat: Infinity, repeatDelay: 3 }}
                >
                  <CountUp end={35} suffix="%" duration={2500} />
                </motion.div>
                <div className="text-sm text-gray-600 group-hover:text-warning-yellow transition-colors">{t('stats.cost_reduction')}</div>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 50, scale: 0.8 }}
                animate={{ opacity: 1, y: 0, scale: 1 }}
              ...
              >
                ...
                <div className="text-sm text-gray-600 group-hover:text-warning-yellow transition-colors">{t('stats.availability')}</div>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 50, scale: 0.8 }}
                animate={{ opacity: 1, y: 0, scale: 1 }}
              ...
              >
                ...
                <div className="text-sm text-gray-600 group-hover:text-warning-yellow transition-colors">{t('common.support')}</div>
              </motion.div>
            </div>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4">
              <Button href="/tevredenheidscheck" size="lg" className="bg-warning-yellow text-black hover:bg-primary-600 font-bold shadow-lg">
                {t('hero.cta.primary')}
              </Button>
              <Button href="/case-studies" variant="outline" size="lg" className="border-warning-yellow text-warning-yellow hover:bg-warning-yellow hover:text-black">
                {t('testimonials.more')}
              </Button>
            </div>
